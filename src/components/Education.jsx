...
const EducationSection = () => {
  ...
  const educationData = [
    ...
    {
      degree: "College Credit Plus",
      school: "Columbus State Community College",
      mascot: "📗",
      year: "2021-2023",
      achievements: ["GPA: 4.00", "Dean's List"],
      skills: ["Calculus", "HTML/CSS", "Economics", "History"],
      description:
        "Developed strong critical thinking skills in high school while taking sponsored college credits.",
    },
  ];
